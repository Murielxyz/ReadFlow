...
const styles = StyleSheet.create({
  ...
  gridCovers: { flex: 1, flexDirection: 'row', flexWrap: 'wrap', gap: 1, padding: 1, paddingTop: 14 },
  miniCover: { width: '48%', aspectRatio: 0.7, borderRadius: 2 },
  miniCoverPh: { width: '48%', aspectRatio: 0.7, borderRadius: 2, alignItems: 'center', justifyContent: 'center' },
  miniCoverTxt: { fontFamily: 'PlusJakartaSans_700Bold', fontSize: 8, fontWeight: '700', color: '#7C6BFF' },
  stackCovers: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingTop: 14 },
  stackCover: { width: '75%', aspectRatio: 0.7, borderRadius: 3, position: 'absolute' },
